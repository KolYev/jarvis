...
" На данный момент ты имеешь полный доступ к своей памяти на основе инструментов UpdateProfile, RememberFact, RecallFacts. Используй эти инструменты, чтобы знать максимум о пользователе, с которым ты общаешься."
"Также ты можешь использовать инструмент websearch для поиска информации в интернете, если это необходимо, а также инструмент FileReader, который позволит читать файлы." \
